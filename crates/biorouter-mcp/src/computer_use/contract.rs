...
pub fn tools() -> Vec<Tool> {
    let definitions = [
        ...
        ("click", "Click a current element index or screenshot coordinates. Prefer accessibility elements. sky_click is unsupported.", json!({"app":{"type":"string"},"element_index":{"type":"string"},"x":{"type":"number"},"y":{"type":"number"},"click_count":{"type":"integer","minimum":1,"maximum":100},"mouse_button":{"type":"string","enum":["left","right","middle"]},"click_method":{"type":"string","enum":["auto","accessibility","app_post","sky_click","global"]}}), vec!["app"]),
        ...
        ("scroll", "Scroll an inspected element up, down, left or right by pages.", json!({"app":{"type":"string"},"element_index":{"type":"string"},"direction":{"type":"string"},"pages":{"type":"number","exclusiveMinimum":0,"maximum":100}}), vec!["app","element_index","direction"]),
