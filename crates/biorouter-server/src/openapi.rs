...
#[openapi(
    ...
    paths(
        super::routes::crew::list_connections,
        super::routes::crew::prepare_device,
        super::routes::crew::save_connection,
        super::routes::crew::update_connection,
        super::routes::crew::remove_connection,
        ...
        super::routes::crew::cancel_run,
        super::routes::crew::grant_session,
        super::routes::crew::host_start,
        super::routes::crew::host_start_state,
        super::routes::crew::host_start_cancel,
        super::routes::crew_observation::observe,
        ...
        super::routes::crew_transfers::pause,
        super::routes::crew_transfers::forget,
        super::routes::crew_transfers::preview,
        super::routes::crew_profile::credentials,
        super::routes::crew_profile::init,
        super::routes::crew_profile::unlock,
        super::routes::crew_profile::lock,
        super::routes::crew_profile::grants,
        super::routes::crew_profile::context,
        super::routes::crew_profile::revoke,
        ...
        super::routes::computer_use::status,
        super::routes::computer_use::setup,
        super::routes::computer_use::consent,
        super::routes::computer_use::revoke,
        super::routes::agent::agent_remove_extension,
        super::routes::agent::update_agent_provider,
        super::routes::action_required::respond_to_elicitation,
    ...
    components(schemas(
        ...
        // "Start it for me" (D-HOST): the request, the run and what it names by `$ref`.
        biorouter::crew::HostStartRequest,
        biorouter::crew::HostStartStatus,
        biorouter::crew::HostStartState,
        biorouter::crew::StartOutput,
        biorouter::crew::HostStartError,
        super::routes::crew_transfers::Resume,
        ...
        super::routes::action_required::ElicitationResponseRequest,
        ...
        super::routes::reply::InterruptRefusal,
        super::routes::reply::InterruptRefusalReason,
        biorouter::agents::SteerWaitReason,
        biorouter::conversation::message::SteerOutcome,
        ...
        super::routes::session::RunningTurnPhase,
