            ...
            match name {
                ...
                "request" => {
                    let id = args
                        ...
                        .ok_or_else(|| anyhow::anyhow!("connection_id is required"))?;
                    let method = args
                        .get("method")
                        .and_then(Value::as_str)
