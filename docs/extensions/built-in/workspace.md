...
- **adds a process-spawning capability or extension** (Developer, Biorouter Copilot, Code Execution, and anything the config describes as running a command), or one that sends the conversation's traffic to a remote endpoint;
