...
| G09 | AWS instances, volumes, security groups, keys and fixture credentials are deleted and independently verified. | AWS cleanup report and post-cleanup resource queries | pass for recorded fixtures | Current fixture cleanup independently verified at 20:33 UTC: exact instance terminated, volume/group/key absent and local keys removed per 20:30:26 receipt. Earlier old-fixture evidence is separate. Future SSH acceptance requires a new disposable fixture. |
