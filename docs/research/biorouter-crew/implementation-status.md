...
| G09 | AWS instances, volumes, security groups, keys and fixture credentials are deleted and independently verified. | AWS cleanup report and post-cleanup resource queries | historical pass; current cleanup pending | The earlier fixture was independently cleaned at 13:40 UTC. The current approved AWS fixture is still live; persistent supervisor 7908 replaces 61914 and targets absolute 2026-09-23 08:15:00 UTC. Termination and absence of its volume/security group/keypair/local credentials must still be independently verified. |
