...
export const connect = <ThrowOnError extends boolean = false>(options: Options<ConnectData, ThrowOnError>) => (options.client ?? client).post<ConnectResponses, unknown, ThrowOnError>({ url: '/crew/connections/{id}/connect', ...options });
