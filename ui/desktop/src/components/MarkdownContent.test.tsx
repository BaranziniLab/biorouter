...
describe('MarkdownContent', () => {
  describe('fenced blocks', () => {
    ...
    it('highlights an R Markdown chunk header', async () => {
      const { container } = render(
        <MarkdownContent content={'```{r setup, include=FALSE}\nx <- TRUE\n```'} />
      );
      await waitFor(() => expect(container.querySelector('.biorouter-md-code')).not.toBeNull());
  ...
  describe('line breaks', () => {
    it('keeps chat hard breaks, and soft-wraps a document when asked', async () => {
